...
import com.appscloud.wallpapersjava.categorias.videojuegosadmin.AgregarVidegamesActivity;
import com.appscloud.wallpapersjava.categorias.videojuegosadmin.CategoriaVidegamesAdmin;
import com.appscloud.wallpapersjava.categorias.videojuegosadmin.Videojuego;
import com.appscloud.wallpapersjava.categorias.videojuegosadmin.ViewHolderVideojuegos;
...
public class VideojuegosClienteActivity extends AppCompatActivity {
    private RecyclerView recyclerViewVideojuegosCliente;
    ...
    // es decir que estara escuchando en tiempo real los cambios que se realicen dentro de una
    // ubicación en un dato especifico este caso es para el dato vistas.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewVideojuegosCliente = findViewById(R.id.recyclerView_videojuegos_cliente);
        recyclerViewVideojuegosCliente.setHasFixedSize(true);//establecemos que el recyclerView se adapte al momento que nosotros eliminemos o agreguemos un nuejvo elemento.
    ...
    private void listarImagenesDeVideojuegos() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Videojuego, ViewHolderVideojuegos>(firebaseRecyclerOptions) {
            @Override
            protected void onBindViewHolder(@NonNull ViewHolderVideojuegos holder, int position,
                                            @NonNull Videojuego videojuego) {
                holder.establecerVideojuego(getApplicationContext(), videojuego.getNombre(),
            ...
            public ViewHolderVideojuegos onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                viewHolderVideojuegos.setOnClickListener(new ViewHolderVideojuegos.CLickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent intentInfoDetalle = new Intent(VideojuegosClienteActivity.this,
        ...
        if (ordenarEn.equals("Dos")) {
            ...
            recyclerViewVideojuegosCliente.setLayoutManager(new GridLayoutManager(this, 2));
            ...
            recyclerViewVideojuegosCliente.setAdapter(firebaseRecyclerAdapter);


        } else if (ordenarEn.equals("Tres")) {
            //con esta línea listamos nuestras imágenes en tress columnas
            recyclerViewVideojuegosCliente.setLayoutManager(new GridLayoutManager(this, 3));
            firebaseRecyclerAdapter.startListening();//para que el recyclerView este escuchando al momento de agregar o eleiminar imágenes
            recyclerViewVideojuegosCliente.setAdapter(firebaseRecyclerAdapter);
    ...
    /*Con este método al abrir  nuestra activity  firebaserecycleradapter
   va estas escuchando si las imágenes fueron traidas exitosamente*/
    ...
    private void ordenarImagenes() {
        ...
        Typeface typeface = Typeface.createFromAsset(VideojuegosClienteActivity.this.getAssets(), rutaFuente);
