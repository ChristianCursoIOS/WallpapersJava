...
public class AgregarPeliculaActivity extends AppCompatActivity {
    private TextView tVVistasPelikcula, idPeliculas;
    private EditText eTNombrePelicula;
    private ImageView iVAgregarPelicula;
    private Uri rutaArchivoUri = null;
    private final String rutaDeAlmacenamiento = "pelicula_subida/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assert actionBar != null; //Afirmamos que actionBar no es nulo
        actionBar.setTitle("Publicar");
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setDisplayShowHomeEnabled(true);

        //Inicializamos nuestras variables del xml
        idPeliculas = findViewById(R.id.id_pelicula);
        tVVistasPelikcula = findViewById(R.id.tV_vistas_pelicula);
        eTNombrePelicula = findViewById(R.id.eT_escribe_nombre);
        iVAgregarPelicula = findViewById(R.id.iV_agregar_pelicula);
        Button btnPublicarPelicula = findViewById(R.id.btn_publicar_pelicula);

        //Inikcializamos nuestras variables de Firebase
        storageReference = FirebaseStorage.getInstance().getReference();
        final String rutaDeBaseDeDatos = "peliculas_db";
        ...
        if (bundle != null) {
            ...
            idPeliculas.setText(recibirId);
            eTNombrePelicula.setText(recibirIntentNombre);
            tVVistasPelikcula.setText(recibirIntentVistas);
            Picasso.get().load(recibirIntentImagen).into(iVAgregarPelicula);
            ...
            btnPublicarPelicula.setText(actualizar);
        ...
        iVAgregarPelicula.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnPublicarPelicula.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (btnPublicarPelicula.getText().equals("Publicar")) {
                    subirImagen();
    ...
    private void eliminarImagenAnterior() {
        ...
        storageReferenceImage.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(AgregarPeliculaActivity.this, "La imágen anterior a sido eliminada",
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AgregarPeliculaActivity.this, e.getMessage(),
                        Toast.LENGTH_SHORT).show();
    ...
    private void subirNuevaImagen() {
        ...
        Bitmap bitmap = ((BitmapDrawable) iVAgregarPelicula.getDrawable()).getBitmap();
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AgregarPeliculaActivity.this, "Nueva imágen cargada",
                        Toast.LENGTH_SHORT).show();
    ...
    private void actualizarImagenEnLaBaseDeDatos(String nuevaImagen) {
        ...
        final String nombreActualizqr = eTNombrePelicula.getText().toString();
        ...
        DatabaseReference databaseReferenceActualizar = firebaseDatabase.getReference("peliculas_db");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                progressDialog.dismiss();
                Toast.makeText(AgregarPeliculaActivity.this, "Actualizado correctamente",
                        Toast.LENGTH_SHORT).show();
    ...
    //método subir una imágen
    private void subirImagen() {
        String mNombre = eTNombrePelicula.getText().toString();
        if (mNombre.equals("") || rutaArchivoUri == null) {
            Toast.makeText(this, "Asigne un nombre o una imágen", Toast.LENGTH_SHORT).show();

        } else {
            progressDialog.setTitle("Espere por favor");
            progressDialog.setMessage("Subiendo imágen en pelicula");
            progressDialog.show();
            progressDialog.setCancelable(false);
            ...
            mStorageReference.putFile(rutaArchivoUri)// sirve para enviar la img dentor del apartado del storage
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            String mVistas = tVVistasPelikcula.getText().toString();
                            ...
                            Pelicula pelicula = new Pelicula(mNombre + "/" + mID, mNombre, descargauri.toString(), numVistas);
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(AgregarPeliculaActivity.this, "Subido exitosamente",
                                    Toast.LENGTH_SHORT).show();
        ...
        public void onActivityResult(ActivityResult result) {
            ...
            try {
                ...
                if (result.getResultCode() == Activity.RESULT_OK) {
                    ...
                    iVAgregarPelicula.setImageURI(rutaArchivoUri);

                } else {
                    Toast.makeText(AgregarPeliculaActivity.this, "Cancelado", Toast.LENGTH_SHORT).show();
                }

            } catch (Exception e) {
                Toast.makeText(AgregarPeliculaActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
