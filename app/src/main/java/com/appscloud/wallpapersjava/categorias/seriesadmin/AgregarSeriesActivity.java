...
public class AgregarSeriesActivity extends AppCompatActivity {

    private TextView tVVistasSerie, idSeries;
    private EditText eTNombreSerie;
    private ImageView iVAgregarSerie;

    private Uri rutaArchivoUri = null;
    private final String rutaDeAlmacenamiento = "imgSerie_subida/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idSeries = findViewById(R.id.id_series);
        tVVistasSerie = findViewById(R.id.tV_vistas_serie);
        eTNombreSerie = findViewById(R.id.eT_escribe_nombre_serie);
        iVAgregarSerie = findViewById(R.id.iV_agregar_serie);
        Button btnPublicarSerie = findViewById(R.id.btn_publicar_serie);

        //Inikcializamos nuestras variables de Firebase
        storageReference = FirebaseStorage.getInstance().getReference();
        final String rutaDeBaseDeDatos = "imgSeries_db";
        ...
        if (bundle != null) {
            ...
            idSeries.setText(recibirId);
            eTNombreSerie.setText(recibirIntentNombre);
            tVVistasSerie.setText(recibirIntentVistas);
            Picasso.get().load(recibirIntentImagen).into(iVAgregarSerie);
            ...
            btnPublicarSerie.setText(actualizar);
        ...
        iVAgregarSerie.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnPublicarSerie.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (btnPublicarSerie.getText().equals("Publicar")) {
                    subirImagen();
    ...
    private void eliminarImagenAnterior() {
        ...
        storageReferenceImage.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(AgregarSeriesActivity.this, "La imágen anterior a sido eliminada",
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AgregarSeriesActivity.this, e.getMessage(),
                        Toast.LENGTH_SHORT).show();
    ...
    private void subirNuevaImagen() {
        ...
        Bitmap bitmap = ((BitmapDrawable) iVAgregarSerie.getDrawable()).getBitmap();
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AgregarSeriesActivity.this, "Nueva imágen cargada",
                        Toast.LENGTH_SHORT).show();
    ...
    private void actualizarImagenEnLaBaseDeDatos(String nuevaImagen) {
        ...
        final String nombreActualizqr = eTNombreSerie.getText().toString();
        ...
        DatabaseReference databaseReferenceActualizar = firebaseDatabase.getReference("imgSeries_db");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                progressDialog.dismiss();
                Toast.makeText(AgregarSeriesActivity.this, "Actualizado correctamente",
                        Toast.LENGTH_SHORT).show();
            ...
            mStorageReference.putFile(rutaArchivoUri)// sirve para enviar la img dentor del apartado del storage
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            String mVistas = tVVistasSerie.getText().toString();
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(AgregarSeriesActivity.this, "Subido exitosamente",
                                    Toast.LENGTH_SHORT).show();

                           /* startActivity(new Intent(AgregarSeriesActivity.this,
                                    CategoriaSeriesAdmin.class));*/
                            finish();
                        }
        ...
        public void onActivityResult(ActivityResult result) {
            ...
            try {
                ...
                if (result.getResultCode() == Activity.RESULT_OK) {
                    ...
                    iVAgregarSerie.setImageURI(rutaArchivoUri);

                } else {
                    Toast.makeText(AgregarSeriesActivity.this, "Cancelado", Toast.LENGTH_SHORT).show();
                }

            } catch (Exception e) {
                Toast.makeText(AgregarSeriesActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
